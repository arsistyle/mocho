...
const Listado = [
  ...
  },
  {
    ...
    state: true,
    valor: '$3.500',
    image: images['batman-cana-full'],
    extraData: 'Calcetas cana, full body',
  },
  {
    name: 'Batman',
    state: true,
  ...
  {
    name: 'Escandalosos - Panda',
    state: true,
    valor: '$3.500',
    image: images['bears-panda-cana'],
    extraData: 'Calcetas caña, Panda',
  },
  {
    ...
    extraData: 'Calcetas caña, Grizzly',
  },
  {
    name: 'Escandalosos - Pardo',
    state: true,
    valor: '$3.500',
    image: images['bears-pardo-cana-pattern'],
  ...
  },
  {
    ...
    state: true,
    valor: '$3.500',
    image: images['bears-polar-cana'],
    extraData: 'Calcetas caña, Icebear',
  },
  {
    name: 'Escandalosos - Polar',
    state: true,
    valor: '$3.500',
    image: images['bears-polar-cana-full-face'],
    extraData: 'Calcetas caña, Full face',
  },
  {
    name: 'Escandalosos - Polar',
    state: true,
  ...
  },
  {
    ...
    state: true,
    valor: '$3.500',
    image: images['capitan-america-cana-full'],
    extraData: 'Calcetas caña, Full',
  },
  {
    name: 'Capitan América',
    state: true,
  ...
  },
  {
    ...
    state: true,
    valor: '$2.500',
    image: images['disney-genio'],
    extraData: 'Calcetas cortas, full body',
  },
  {
    name: 'Disney - Stich',
    state: true,
  ...
  },
  {
    ...
    state: true,
    valor: '$2.500',
    image: images['frozen-ana'],
    extraData: 'Calcetas cortas, ana',
  },
  {
    name: 'Hulk',
    state: true,
  ...
  },
  {
    ...
    state: true,
    valor: '$3.500',
    image: images['ironmman-cana-full'],
    extraData: 'Calcetas caña, full',
  },
  {
    name: 'Loki',
  ...
  {
    name: 'Shaun el cordero - Shaun',
    state: true,
    valor: '$2.500',
    image: images['shaun-shaun'],
    extraData: 'Calcetas cortas',
  },
  {
    name: 'Shaun el cordero - Wallace',
    state: true,
    valor: '$2.500',
    image: images['shaun-wallace'],
    extraData: 'Calcetas cortas',
  },
  {
    name: 'Snoopy',
  ...
  },
  {
    ...
    state: true,
    valor: '$3.500',
    image: images['spiderman-cana-full'],
    extraData: 'Calcetas caña, full',
  },
  {
    name: 'Spider-Man',
  ...
  },
  {
    ...
    state: true,
    valor: '$3.500',
    image: images['superman-cana-full'],
    extraData: 'Calcetas caña, full body',
  },
  {
    name: 'Superman',
    state: true,
  ...
  {
    name: 'Toy Story - Betty',
    state: true,
    valor: '$2.500',
    image: images['toy-story-betty'],
    extraData: 'Calcetas cortas, full',
  },
  {
    name: 'Toy Story - Forky',
    state: true,
    valor: '$2.500',
    image: images['toy-story-forky'],
    extraData: 'Calcetas cortas, full',
  },
  {
    name: 'Toy Story - Buzz Lightyear',
    state: true,
    valor: '$2.500',
    image: images['toy-story-buzz'],
    extraData: 'Calcetas cortas, full',
  },
  {
    name: 'Toy Story - Buzz & Woody',
    state: true,
    valor: '$2.500',
    image: images['toy-story-woody-buzz'],
    extraData: 'Calcetas cortas, full',
  },
  {
    name: 'Venom',
